                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-custom m-0">
                            ...
                            <tbody>
                                ...
                                <tr><td colspan="7" class="text-center py-4">Chưa có đơn đặt hàng nào.</td></tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="small fw-bold"><?= htmlspecialchars($order->phone) ?></div>
                                        <div class="small text-muted" style="max-width: 250px; text-overflow: ellipsis; overflow: hidden; white-space: nowrap;" title="<?= htmlspecialchars($order->address) ?>">
